...
R , Oil = mFO.generateOilArchData(T,N)


#data = loadmat('BaryDataMatrixOil.mat')
#R = data['xsimDataOil']
...
def make_env(): # Vectorize environment for parallel PPO training
    return mFO.PortfolioEnvOil(R, Oil, q=q, k=k, include_action=include_action, include_vol=include_vol)
